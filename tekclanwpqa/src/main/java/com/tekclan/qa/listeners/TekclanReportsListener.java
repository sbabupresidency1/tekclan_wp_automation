package com.tekclan.qa.listeners;
...
import com.tekclan.qa.exceptions.TekclanReporterStepFailedException;
import com.tekclan.qa.utils.Attributes;
import com.tekclan.qa.utils.Directory;
import com.tekclan.qa.utils.Platform;
import com.tekclan.qa.utils.SettingsFile;
import com.tekclan.qa.utils.TestParameters;
import com.tekclan.qa.writers.ConsolidatedReportsPageWriter;
import com.tekclan.qa.writers.CurrentRunPageWriter;
import com.tekclan.qa.writers.HTMLDesignFilesJSWriter;
import com.tekclan.qa.writers.IndexPageWriter;
import com.tekclan.qa.writers.TestCaseReportsPageWriter;

public class TekclanReportsListener implements ITestListener, IExecutionListener, IReporter, ISuiteListener {

	static Logger log = Logger.getLogger(TekclanReportsListener.class.getName());
	int runCount = 0;
	...
	public void onTestSuccess(ITestResult result)  {
		try
		{
			...
			{
				result.setStatus(2);
				result.setThrowable(new TekclanReporterStepFailedException());
	...
	public static void setPlatfromBrowserDetails(ITestResult paramITestResult)  {
		Platform.prepareDetails(TekclanReports.getWebDriver());
	...
	public void generateIndexPage()  {
		...
		try
		{
			...
			IndexPageWriter.content(localPrintWriter, TekclanReports.indexPageDescription);
