...
import com.tekclan.qa.utils.AuthorDetails;
import com.tekclan.qa.utils.Directory;
import com.tekclan.qa.utils.Platform;
import com.tekclan.qa.utils.Steps;

public class TekclanReports {
	private static WebDriver driver;
	public static final int MAX_BAR_REPORTS = 10;
	public static final String MESSAGE = "Tekclan Reporter: Preparing Reports";
	...
	private static void stepFailureHandler(ITestResult ITestResult, Steps Steps, LogAs logAs)  {
		if (logAs == LogAs.FAILED)
		{
			...
			if (Directory.continueExecutionAfterStepFailed) {
				...
				throw new TekclanReporterStepFailedException();
			}
			return;
		}
		buildReportData(Steps);
