...
public class SettingsFile {
	...
	public static void initSettingsFile() throws TekclanReporterException  {
	...
	public static void create(String paramString) throws TekclanReporterException  {
		...
		{
			throw new TekclanReporterException("Unable To Create Required Files for Custom Reports");
		}
	}

	public static void open() throws TekclanReporterException  {
		...
		{
			throw new TekclanReporterException("Settings File Not Available");
		}
		catch (IOException localIOException)
		{
			throw new TekclanReporterException("Unable To Create Required Files for Custom Reports");
	...
	public static void close() throws TekclanReporterException  {
		try
		{
	...
	public static void correctErrors() throws NumberFormatException, TekclanReporterException  {
	...
	public static int getHighestTestCaseNumber() throws TekclanReporterException  {
	...
	public static String get(String propertyKey) throws TekclanReporterException  {
		open();
	...
	public static void set(String key, String value) throws TekclanReporterException  {
		open();
